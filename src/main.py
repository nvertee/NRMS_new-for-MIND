...
def train_and_evaluate(training_data, validation_data):
    ...
    train_loader = Data.DataLoader(dataset=train_data_index, batch_size=batch_size, shuffle=True, num_workers=4, drop_last=False)
    ...
    vali_loader = Data.DataLoader(dataset=validate_data_index, batch_size=batch_size, shuffle=True, num_workers=4, drop_last=True)
